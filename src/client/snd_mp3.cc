...
#include "client.hh"
#include "snd_mp3.hh"					// only included directly by a few snd_xxxx.cpp files plus this one
#include "mp3code/mp3struct.hh"	// keep this rather awful file secret from the rest of the program
