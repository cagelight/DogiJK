...
XCVAR_DEF( g_logFile,					"games.log",	NULL,				CVAR_ARCHIVE,									qfalse )
...
XCVAR_DEF( g_saberRealisticCombat,		"0",			NULL,				CVAR_ARCHIVE,									qfalse )
...
XCVAR_DEF( g_physics_pushmult,			"2.0",			NULL,				CVAR_ARCHIVE,									qtrue )

// EEGG
XCVAR_DEF( g_eegg_sdintra,				"512",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_eegg_sdinter,				"256",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_eegg_cullthresh,			"128",			NULL,				CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( g_eegg_sightcheck,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_eegg_cpusage,				"1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_eegg_branches,				"32",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_eegg_dropout,				"0.0",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( g_eegg_patchtest,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( weap_conc_grav,				"0",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_conc_velocity,			"3000",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_detpack_stack,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_flec_shots,				"5",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_kickDamMin,				"10",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_kickDamMax,				"15",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_kickDistMin,			"50.0",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_kickDistMax,			"100.0",		NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_rep_bounceAlt,			"0",			NULL,				CVAR_ARCHIVE,									qtrue )
XCVAR_DEF( weap_rep_gravAlt,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
//weap_snip_bounce IN bg_xcvar.h
