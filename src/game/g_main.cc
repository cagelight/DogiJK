...
gentity_t *SelectRandomDeathmatchSpawnPoint( qboolean );
...
extern "C" Q_EXPORT gameExport_t* QDECL GetModuleAPI( int apiVersion, gameImport_t *import )
{
